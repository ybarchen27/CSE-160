...
class Vector3 {
    ...
    static dot(other1, other2) {
      let a0b0 = other1.elements[0] * other2.elements[0];
      let a1b1 = other1.elements[1] * other2.elements[1];
      let a2b2 = other1.elements[2] * other2.elements[2];

      return a0b0 + a1b1 + a2b2;
    }
    ...
    static cross(other1, other2) {
      ...
      let j = other1.elements[2] * other2.elements[0] - other1.elements[0] * other2.elements[2];
